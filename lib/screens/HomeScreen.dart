...
class _HomeScreenState extends State<HomeScreen> {
  ...
  _imageFromCamera() async {
    try {
      ...
      if (capturedImage == null) {
        showAlert(
            bContext: context,
            title: "Error al elegir archivo",
            content: "No se seleccionó ningún archivo");
      } else {
        setState(() {
          _image = imagePath;
        });
      ...
      showAlert(
          bContext: context,title: "Error al capturar el archivo de imagen", content: e);
    }
  }
  ...
  _imageFromGallery() async {
    ...
    if (uploadedImage == null) {
      showAlert(
          bContext: context,
          title: "Error al elegir el archivo",
          content: "No se seleccionó ningún archivo");
    } else {
      setState(() {
        _image = imagePath;
